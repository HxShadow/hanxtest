...
$(document).ready(function(){
	...
	window.CMSCMT = {
		...
		imgHost: 'https://v2.CMSCMT.cc/code/images/',		
			...
			$.getJSON(src_conf+"&jsoncallback=?",function(PARAM){
				...
				CMSCMT.lang = PARAM.lang;
					try{
						...
						window.CMSCMT.sjs += "<a  id=\"uyan_cmt_btn\" onclick=\"window.CMSCMT.addCmt(this);\"  class='submit' data-track='submit'>";
						...
						if(CMSCMT.conf.islogin == 1){
							...
							window.CMSCMT.sjs += "<dd class='msg'><a href=\""+ CMSCMT.conf.home +"\" target='_blank'><span class='name'>"+CMSCMT.conf.uname+"</span></a>"+CMSCMT.lang.userStr1+"</dd>";
						}else if(CMSCMT.conf.islogin == 0){
							window.CMSCMT.sjs += "<dt class='icon'><img src='https://comment.51cto.com/static/images/duface.png' alt=\"\" /></dt>";
                            ...
                            var cur_host = window.location.host;
                            if (/\.51cto\.com/.test(cur_host) == true && navigator.userAgent.match(/iPhone/i)==null && navigator.userAgent.match(/Android/i)==null) {
                                window.CMSCMT.sjs += "&nbsp;<a href='javascript:void(0)' style='color:red;' onclick=\"show_iframe_login('"+ url +"');return false;\">" + CMSCMT.lang.userStr4 + "</a>&nbsp;";
                            } else {
						...
						// 添加弹框登录图层
						window.CMSCMT.sjs += "<div class='ui-overlay-mask' style='display: none;position: fixed; text-align:center;left:0; top:0; height:100%; width:100%;z-index: 9999;background-color:rgba(0, 0, 0, 0.6);'>";
						window.CMSCMT.sjs += "<div id='login' style='left:0; top:0;z-index: 9999;background:#fff;margin:20px auto;position:relative;display: inline-block;top: 40%;transform: translateY(-50%);'><span class='offbtn' onclick='hide()' style='position: absolute; right:15px; top:20px; display:inline-block; width:15px; height:14px;background: url(https://static1.51cto.com/home/web/images/iframe_login/offbtn.png) no-repeat center center; z-index: 99; cursor:pointer;'></span>";
						window.CMSCMT.sjs += "</div></div>";
	...
	isforbid: function () {
      ...
      sleep: function (numberMillis) { 
        ...
        cmtShare : function(t,cont){
			...
			var url='';	
			if(t=='tqq'){
				url='https://share.v.t.qq.com/index.php?c=share&a=index&url='+ CMSCMT.conf.url +'&title='+ cont ;	
			}else if(t=='sina'){
				var sinaTitle='';
				...
				url='https://service.weibo.com/share/share.php?title='+ sinaTitle +'&url='+ CMSCMT.conf.url +'#jtss-tsina&source=bookmark&appkey=2378297317&pic=&ralateUid=';	
			}else if(t=='qzone'){
				url='https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url='+ CMSCMT.conf.url +'%23jtss-qzone&title='+ cont +'&summary=-+51CTO.COM';	
			}
...
//        		alert(val.uname);        		
					...
					strVar += "<a class=\"jiathis_button_tsina\" onclick=\"CMSCMT.cmtShare('sina','"+ val.content +"');\"><img src='https://s2.51cto.com/wyfs02/M00/58/35/wKioL1SsonugeKo0AAAGlF6KMqM876.png' alt=''></a>";
					strVar += "<a class=\"jiathis_button_qzone\" onclick=\"CMSCMT.cmtShare('qzone','"+ val.content +"');\"><img src='https://s3.51cto.com/wyfs02/M02/58/39/wKiom1SsobuxdEMvAAAF92NU77A112.png' alt=''></a>";
					strVar += "<a class=\"jiathis_button_tqq\" onclick=\"CMSCMT.cmtShare('tqq','"+ val.content +"');\"><img src='https://s8.51cto.com/wyfs02/M00/58/39/wKiom1SsobuDEp5ZAAAGB9ePTKU216.png' alt=''></a>";
					strVar += "</div></div>";
       ...
       showReplylist: function (rs, is_return,rpyid){
      	...
      	$(list).each(function (key, val){ 
			...
			restrVal += "								<a class=\"jiathis_button_tsina\"  onclick=\"CMSCMT.cmtShare('sina','"+ val.content +"');\"><img src='https://s2.51cto.com/wyfs02/M00/58/35/wKioL1SsonugeKo0AAAGlF6KMqM876.png' alt=''></a>";
			restrVal += "								<a class=\"jiathis_button_qzone\"  onclick=\"CMSCMT.cmtShare('qzone','"+ val.content +"');\"><img src='https://s3.51cto.com/wyfs02/M02/58/39/wKiom1SsobuxdEMvAAAF92NU77A112.png' alt=''></a>";
			restrVal += "								<a class=\"jiathis_button_tqq\" onclick=\"CMSCMT.cmtShare('tqq','"+ val.content +"');\"><img src='https://s8.51cto.com/wyfs02/M00/58/39/wKiom1SsobuDEp5ZAAAGB9ePTKU216.png' alt=''></a>";
			restrVal += "							</div>";
			restrVal += "						</div>";
		...
		changeS: function (){
         ...
         addCmtDo: function (rs){
			 ...
			 if(rs){		
				var cmt_cont='<li id="cmt_'+ rs +'" class="element"><dl><dt class="head"><a href="#" style="cursor: pointer; text-decoration: none; white-space: inherit;" target="_blank"><img style="border: 0 none; box-shadow: 0 1px 5px rgba(0, 0, 0, 0.22); border-radius: 4px; width: 50px; height: 50px;" onload="CMSCMT.loadUface(this, \''+ CMSCMT.conf.uface +'\', \'https://v2.CMSCMT.cc/code/images/duface.png\');" src="'+ CMSCMT.conf.uface +'" ></a></dt><dd><div class="name"><a id="cmt_uname_'+ rs +'"  href="'+  CMSCMT.conf.home +'" target="_blank" >'+ CMSCMT.conf.uname +'</a></div><p class="con">'+ CMSCMT.conf.content +'</p><div class="tool line one"><div class="date">'+ CMSCMT.lang.userStr9 +''+ CMSCMT.get_date() +'</div><div class="btn"><div class="shareBox"><div class=\"jiathis_style_24x24\"><a class=\"jiathis_button_tsina\" onclick="CMSCMT.cmtShare(\'sina\',\''+ CMSCMT.conf.content +'\');"><img src=\"https://s2.51cto.com/wyfs02/M00/58/35/wKioL1SsonugeKo0AAAGlF6KMqM876.png\" ></a><a class=\"jiathis_button_qzone\" onclick="CMSCMT.cmtShare(\'qzone\',\''+ CMSCMT.conf.content +'\');"><img src=\"https://s3.51cto.com/wyfs02/M02/58/39/wKiom1SsobuxdEMvAAAF92NU77A112.png\"></a><a class=\"jiathis_button_tqq\" onclick="CMSCMT.cmtShare(\'tqq\',\''+ CMSCMT.conf.content +'\');"><img src=\"https://s8.51cto.com/wyfs02/M00/58/39/wKiom1SsobuDEp5ZAAAGB9ePTKU216.png\"></a></div></div><a id="cmt_rpy_'+ rs +'" onclick="CMSCMT.addRpyBox('+ rs +','+ rs +',\'one\');" class="reply self"  style="cursor: pointer;">'+ CMSCMT.lang.addRpy +'</a><a onclick="CMSCMT.cmtUD('+ rs +');" class=\"support self\">'+ CMSCMT.lang.dS +'<span id="zan_'+ rs +'">0</span></a><a class=\"share self\">'+ CMSCMT.lang.cmtShare +'</a></div></div><ul id="cmt_reply_list_'+ rs +'" class="list center second"></ul></dd></dl></li>';
		...
		addRpyDo: function (rs){
			...
			var rpy_content='<li id="cmt_'+ rs +'" class="element line"><dl><dt class="head"><a href="'+  CMSCMT.conf.home +'" style="cursor: pointer; text-decoration: none; white-space: inherit;" target="_blank"><img style="border: 0 none; box-shadow: 0 1px 5px rgba(0, 0, 0, 0.22); border-radius: 4px; width: 50px; height: 50px;" onload="CMSCMT.loadUface(this, \''+  CMSCMT.conf.uface +'\', \'https://v2.CMSCMT.cc/code/images/duface.png\');" src="'+  CMSCMT.conf.uface +'" onerror="CMSCMT.noUface(this, \''+  CMSCMT.conf.uface +'\');"></a></dt><dd><div class="name"><a id="cmt_uname_'+ rs +'" href="'+  CMSCMT.conf.home +'" target="_blank">'+  CMSCMT.conf.uname +'</a></div><p class="con">'+ CMSCMT.conf.rpyContent +'</p><div class="tool line"><div class="date">'+CMSCMT.lang.userStr9+ CMSCMT.get_date() +'</div><div class="btn"><div class="shareBox" style="display: none;"><div class="jiathis_style_24x24"><a class="jiathis_button_tsina"  onclick="CMSCMT.cmtShare(\'sina\',\''+ CMSCMT.conf.rpyContent +'\');"><img src="https://s2.51cto.com/wyfs02/M00/58/35/wKioL1SsonugeKo0AAAGlF6KMqM876.png" alt=""></a><a class="jiathis_button_qzone"  onclick="CMSCMT.cmtShare(\'qzone\',\''+ CMSCMT.conf.rpyContent +'\');"><img src="https://s3.51cto.com/wyfs02/M02/58/39/wKiom1SsobuxdEMvAAAF92NU77A112.png" alt=""></a><a class="jiathis_button_tqq"  onclick="CMSCMT.cmtShare(\'tqq\',\''+ CMSCMT.conf.content +'\');"><img src="https://s8.51cto.com/wyfs02/M00/58/39/wKiom1SsobuDEp5ZAAAGB9ePTKU216.png" alt=""></a></div>						</div><a id="cmt_rpy_'+ rs +'" onclick="CMSCMT.addRpyBox('+ rs +','+ CMSCMT.conf.rid +');" style="cursor: pointer;" class="reply self" id="cmt_rpy_'+ rs +'" onclick="CMSCMT.addRpyBox('+ rs +','+ CMSCMT.conf.rid +');">'+ CMSCMT.lang.addRpy +'</a><a style="cursor: pointer;" class="support self" onclick="CMSCMT.cmtUD('+ rs +');" >'+ CMSCMT.lang.dS +'(<span id="zan_'+ rs +'">0</span>)</a><a class="share self">'+ CMSCMT.lang.cmtShare +'</a></div></div></dd></dl></li>';
...
function show_iframe_login(url) {
    window.CMSCMT.init(function () {
        if(CMSCMT.conf.comment_count > 0){
            CMSCMT.getCmt(1); //初始化显示第一页评论，如果有的话。
            new Share({
                btn:$("#uyan_cmt_list").find(".share"),
        ...
        if (window.CMSCMT.conf.islogin == 0) {
            iframe = document.createElement('iframe');
            iframe.src = 'https://home.51cto.com/index/iframe-login?reback='+url;
            iframe.setAttribute('iframeboder',0);
            iframe.setAttribute('scrolling','no');
            iframe.setAttribute('allowTransparency','true');
            iframe.style.border = 'none';
            iframe.height = '400';
            iframe.width = '380';
            iframe.setAttribute('id','login_form');
            iframe.setAttribute('name','login_form');
            $('#login').append(iframe);
            $('.ui-overlay-mask').css('display','block');
		}
    });
	return false;
}
function hide() {
	$('.ui-overlay-mask').hide();
	$('#login_form').remove();
}
